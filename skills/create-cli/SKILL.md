...
- 上流/完全ガイドライン: https://clig.dev/ （変更提案: https://github.com/cli-guidelines/cli-guidelines）
...
- パーサーライブラリ（言語別）の推奨は、求められた時だけにする。基本は言語非依存で保つ。
- リクエストが「パラメータ設計」の場合、実装の話に流れすぎない。
